...
filenames = [name for path, subdirs, files in os.walk("files")
             for name in files]
...
csvfile = open('NotMatched.csv', 'w', newline='')
notmatched = csv.writer(csvfile)
...
with open('Result.csv', 'w', newline='') as csvfile:
    ...
    for i in range(len(filenames)):
        ...
        if (splittedFilename[4] == "spec"):
            ...
            modify = splittedFilename[0]+"."+splittedFilename[1]+"."+splittedFilename[2]+"."+splittedFilename[3]+ "."+splittedFilename[4]
            replicate = splittedFilename[3]
        elif(splittedFilename[4] == "csv"):
            patch = splittedFilename[1]
            id = splittedFilename[2]
            modify = splittedFilename[0]+"."+splittedFilename[1]+"."+splittedFilename[2]+"."+splittedFilename[3]
            replicate = splittedFilename[3]
